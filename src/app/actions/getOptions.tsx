...
export const GetOptions = () => {
    ...
    const [carModels, setCarModel] = useState([
        ...
        { label: 'Berlingo', id: '22', make: 'Citroën' },
        { label: 'C-Crosser', id: '23', make: 'Citroën' },
        { label: 'C-Elissée', id: '24', make: 'Citroën' },
        { label: 'C-Zero', id: '25', make: 'Citroën' },
        { label: 'C1', id: '26', make: 'Citroën' },
        ...
        { label: 'Accord Coupé', id: '53', make: 'Honda' },
        ...
        { label: 'City-Coupé', id: '123', make: 'Smart' },
