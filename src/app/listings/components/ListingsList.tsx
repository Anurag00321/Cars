                ...
                <div className="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                      ...
                      <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div className="mt-2">
                          <p className="text-sm text-gray-500">
                            Are you sure you want to delete this listing? All of
                            the data related to it will be permanently removed.
                  ...
                  <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button
                      ...
                      onClick={() => {
                        setOpen(true), setDeleteConfirm(true);
                      }}
                    >
                      Delete
                    </button>
          ...
          {items?.map((item) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <h3 className="mb-2 text-md font-medium text-gray-300 ">
                  {item.year}, {item.fuel}, {item.mileage}
                </h3>
                <p className="mb-2 text-base text-white">{item.body}</p>
                <div className="flex items-center justify-between">
                  <p className="mr-2 text-lg font-semibold text-white justify-items-end ">
                    €{item.price}
                  </p>
                  <div className="flex">
                    <button
                      onClick={() => handleOnClickEdit(item.slug)}
                      className="text-white focus:ring-4 focus:outline-none font-bold rounded-lg text-sm px-4 py-2 text-center mr-2 md:mr-2 bg-light-green hover:bg-british-green-4 focus:ring-british-green-2"
                    >
                      Edit
                    </button>
                    <button
                      onClick={() => handleDelete(item.slug)}
                      className="text-white focus:ring-4 focus:outline-none font-bold rounded-lg text-sm px-3 py-2 text-center mr-2 md:mr-2 bg-light-green hover:bg-british-green-4 focus:ring-british-green-2"
                    >
                      X
                    </button>
                  </div>
    ...
    return (
      <>
        ...
        <div className="relative flex flex-col items-center justify-center pt-4 appearance-none font-rubik">
          <p className="pt-0 sm:pt-6 md:pt-16 font-bold text-3xl text-gray-800">
            Featured listings
          </p>
            ...
            {items.slice(-3)?.map((item) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="mb-2 text-base font-light text-white ">
                    {item.body}
                  </p>
                  <div className="flex items-center">
                    <p className="mr-2 text-lg font-medium text-gray-200">
                      €{item.price}
                    </p>
                  </div>
                </div>
