          ...
          <main className="sm:flex">
            ...
            <div className="sm:ml-6">
              <div className="sm:border-l sm:border-gray-200 sm:pl-6">
                <h1 className="text-4xl font-bold text-gray-900 tracking-tight sm:text-5xl font-rubik">Page not found</h1>
                <p className="mt-1 text-base text-gray-500 font-rubik">Please check the URL in the address bar and try again.</p>
              </div>
