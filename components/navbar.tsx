...
export const Navbar = () => {
  ...
  return (
    <nav className="border-gray-200 bg-british-green-1">
    ...
    <button 
          ...
          className="text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-4 md:mr-4 border border-white bg-transperant hover:bg-orange-2 dark:focus:ring-british-green-0"
          >Add a listing
          </button>
      {!sessionStatus &&
          <button 
